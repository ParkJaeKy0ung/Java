...
function currentTime(){
    ...
    // 시/분/초가 10 미만(두 자리가 아닐 경우)인 경우 앞에 0 추가
...
openPopup3.addEventListener("click", () => {
    // 새 창에서 크기를 너비 400px, 높이 600px로 지정
    // 열리는 위치는 위에서 100px, 왼쪽에서 100px 떨어진 위치에서 열기

    window.open("07_함수.html", "_blank", "width=300, height=600, top=100, left=100");
});
