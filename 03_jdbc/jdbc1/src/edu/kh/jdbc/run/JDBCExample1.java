...
public class JDBCExample1 {
	public static void main(String[] args) {
		 ...
		 *  2. DBMS의 종류(Oracle)
		 *  3. DBMS 회사에서 제공하는 Java 애플리케이션과 DB 연결을 위한 라이브러리
		...
		try {
			...
			// -> 메모리에 객체가 생성되고 Connection을 이용한 DB 연결 시
			//	  이를 자동으로 참조한다.
