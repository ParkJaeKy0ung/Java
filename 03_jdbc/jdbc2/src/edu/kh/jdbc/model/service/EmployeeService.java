...
//		Connection conn = JDBCTemplate.getConnection();
	 ...
	 * @throws SQLException
	 */
	public List<Employee> selectSalary(int inputMin, int inputMax) throws SQLException{
		
		// 1. Connection 생성
		Connection conn = getConnection();
		
		// 2. DAO 메서드 호출 후 결과 반환
		List<Employee> empList = dao.selectSalary(conn, inputMin, inputMax);
	...
	public int insertEmployee(Employee emp) throws SQLException{
		...
		// -> 수행 결과에 따라 Commit, Rollback 지정해야 함
