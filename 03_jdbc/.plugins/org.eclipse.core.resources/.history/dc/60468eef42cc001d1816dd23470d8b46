package edu.kh.inheritance.dto;
					...
					// 확장 (Parent의 코드를 상속 받아 Child1 확장)
public class Child1 extends Parent{
	...
	public Child1(String car) {
		// super(); // super 생성자 = 부모 클래스
				 // -> 자식 객체 생성 시 부모 객체를 먼저 생성하게 함
				 // ** 미작성 시 컴파일러가 자동 추가
		
		// 부모로부터 상속받은 setter를 이용해서 부모 필드 초기화
//		setMoney(100_000_000);
//		setLastName("김");
		
		// 부모의 필드를 초기화 하는 방법이 부모 매개변수 생성자에 존재
		// -> 이를 호출하여 사용 (코드길이 감소, 재사용성 증가)
		super(200_000_000, "조"); // 부모의 매개변수 생성자 호출
...
//		System.out.println(getLastName());
		...
		// return car + " / " + toString();
							 // super. 안 쓰면 자식클래스 toString 불러와 stackOverflow로 오류 발생
