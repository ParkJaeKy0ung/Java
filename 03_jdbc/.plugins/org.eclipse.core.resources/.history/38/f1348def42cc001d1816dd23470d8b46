...
public class VariableEx2 {
	...
	//  자료형  변수명
		...
		// ** 자료형별로 리터럴 표기 방법 별도 존재 **
		
		// int : 10, -50, 0 (기본 정수 표기법)
		// long : 2147483648L, 0L, -10L (l, L)
		
		// double : 3.14, -123.456, 0.0 (기본 실수 표기법, 모두 실수 형태로 작성(소수점!!))
		...
		// char 변수 선언과 동시에 초기화
		char test1 = 'A'; 
		char test2 = 65; // test2에 65가 들어갈 때 인코딩되어 'A'로 출력됨
