...
SELECT MEMBER_NO, MEMBER_EMAIL, MEMBER_NICKNAME, 
	...
	AUTHORITY, TO_CHAR(ENROLL_DATE, 'YYYY"년" MM"월" DD"일" HH24"시" MI"분" SS"초"') ENROLL_DATE 
FROM "MEMBER"
...
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00001.jpg', '검빵이_1.jpg', 0, 1999);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00002.jpg', '검빵이_2.jpg', 0, 1998);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00003.jpg', '순덕이_1.jpg', 0, 1988);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00004.jpg', '순덕이_6.jpg', 0, 1985);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00005.jpg', 'flower3.jpg', 0, 1981);
...
-- 마이바티스 O (SqlSession, RowBounds 객체)
--> RowBounds 객체 이용
...
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/', '20230508115013_00002.jpg', '검빵이_2.jpg', 1, 1999);

INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/', '20230508115013_00003.jpg', '순덕이_1.jpg', 2, 1999);
...
-- 회원 프로필 이미지 변경
UPDATE "MEMBER" SET
PROFILE_IMG = '/resources/images/member/검빵이_1.jpg'
WHERE MEMBER_NO = 1;
...
FROM (
   SELECT '웹접근경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL,
           0 IMG_ORDER, 1999 BOARD_NO
   FROM DUAL   
   
   UNION ALL
   
   SELECT '웹접근경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL,
           1 IMG_ORDER, 1999 BOARD_NO
   FROM DUAL
   
   UNION ALL
   
   SELECT '웹접근경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL,
           2 IMG_ORDER, 1999 BOARD_NO
   FROM DUAL
) A;
...
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글 1', DEFAULT, DEFAULT, 2009, 1, NULL);

INSERT INTO "COMMENT"									--  게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글 2', DEFAULT, DEFAULT, 2009, 1, NULL);

-- 1001, 1002
INSERT INTO "COMMENT"									--  게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-1', DEFAULT, DEFAULT, 2009, 1, 1001);

INSERT INTO "COMMENT"									--  게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-2', DEFAULT, DEFAULT, 2009, 1, 1001);

INSERT INTO "COMMENT"									--  게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-3', DEFAULT, DEFAULT, 2009, 1, 1001);

INSERT INTO "COMMENT"									--  게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 2-1', DEFAULT, DEFAULT, 2009, 1, 1002);

INSERT INTO "COMMENT"									--  게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 2-2', DEFAULT, DEFAULT, 2009, 1, 1006);

INSERT INTO "COMMENT"									--  게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 2-3', DEFAULT, DEFAULT, 2009, 1, 1002);

INSERT INTO "COMMENT"									--  게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 2-1-1', DEFAULT, DEFAULT, 2009, 1, 1002);

INSERT INTO "COMMENT"									--  게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 2-1-1', DEFAULT, DEFAULT, 2009, 1, 1006);
