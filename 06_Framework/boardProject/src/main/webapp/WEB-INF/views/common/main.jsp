...
<body>
    ...
    <main>
        ...
        <%-- header, nav --> header.jsp(webapp/WEB-INF)로 옮김!!! --%>
        <%-- header.jsp 추가(포함) --%>
        ...
        <section class="content">
            ...
            <section class="content-2">
                ...
                <c:choose>
                    ...
                    <%-- EL empty 연산자 : 비어있거나 null이면 true --%>
                    <c:when test="${empty sessionScope.loginMember}">

                        <%-- method="POST" : 제출되는 값이 주소에 안 보임 --%>
