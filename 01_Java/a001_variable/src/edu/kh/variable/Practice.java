...
public class Practice {
	...
	public static void main(String[] args) {
		...
		// pintln() 자동 완성 : syso -> ctrl + spacebar -> enter
		
		System.out.println(iNum1 / iNum2); // 10 / 4 = 2.5 -> int 버림 으로 값이 2가 나옴
		System.out.println( (int)dNum ); // 2
		System.out.println( iNum2 * dNum ); // 4 * 2.5 = 10 -> double로 형변환되어 10.0 
		...
		System.out.println( iNum1 + ch ); // int + char(->int (자동형변환)) // 75
