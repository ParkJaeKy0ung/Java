...
public class WhileEx {
	...
	public void ex1() {
		...
		int input = -1; // 입력 받은 값을 저장할 변수 (0과 같지 않은 임의의 수로 하면 됨. input이 0이면 종료하기 때문)
	...
	public void ex2() {  // 다시!!!
		...
		int input = 0; // 메뉴 번호를 입력 받을 변수 (input이 9이기 때문에 9가 아닌 임의의 수)
		// input의 값은 while 조건이 false가 되지 않는 값을 작성하면 됨.
		// -> 보통 자료형 범위의 중간값인 0을 사용하고 이를 기본값이라고 함.
	...
	public void ex3() {
		...
		do { // 일단 1회 실행 (while문과 다르게 input 초기값이 0이어도 실행함)
			System.out.print("정수 입력 : ");
			input = sc.nextInt();
