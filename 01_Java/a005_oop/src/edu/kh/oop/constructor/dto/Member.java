...
public class Member {   // 클래스 : 객체의 속성, 기능을 정의한 것
						//			-> 컴퓨터에 객체 만들려고 
						//			--> 생성자가 있어야 객체를 만들 수 있음
	...
	// 인스턴스 변수
	private String memberId ="명시적 초기화";  // 인스턴스 초기화 블럭 보다 우선순위가 높음.
	...
	// 인스턴스 초기화 블럭 : 인스턴스 변수를 초기화 하는 블럭
	{
		...
		// 인스턴스 초기화 블럭에 클래스 변수 초기화해도 실행은 되지만 효율적이지 않음
	}
	...
	public Member(){  // 기본 생성자
		...
		// 객체 생성 시 필드 초기화    (--> 인스턴스 초기화보다 우선순위가 높기 때문에 먼저 출력됨)
		memberId = "user1";
		memberPw = "1q2w3e4r";
		memberName = "홍길동";
		memberAge = 25;
	...
	public Member(String memberId, String memberPw, String memberName, int memberAge) {
		...
		//	 현재 인스턴스 참조함.(가리킴)
		this.memberId = memberId;     // user02  --> ConstructorRun에 입력한 값 호출됨.
		this.memberPw = memberPw;     // pass02
		this.memberName = memberName; // 김삼순
		this.memberAge = memberAge;   // 19
	...
	// public Member(String memberId) {} // 성립
