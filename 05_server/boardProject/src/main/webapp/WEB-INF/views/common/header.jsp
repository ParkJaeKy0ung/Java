...
<header>
    <section>
        ...
        <a href="#">
            <img src="/resources/images/free-icon-animal-shelter-10204272.png" alt="로고" id="homeLogo">
        </a>
    </section>
    ...
    <section>
        ...
        <article class="search-area">
            ...
            <!-- 
                action : 내부 input에 작성된 값을 제출할 경로/주소 작성
                method : 어떤 방식으로 제출할지 지정

                - GET : input 태그 값을 주소에 담아서 제출(주소에 보임) ex) 오늘 날씨
                - POST : input 태그 값을 주소에 담지 않고 제출(주소에 안 보임)
                        -> HTTP Body에 담아서 제출 ex) 아이디, 비밀번호
            -->
