...
messageBoXreciveX.addEventListener("click",()=>{ /* 닫기 */
...
gotoMessagesend.addEventListener("click",()=>{
    messageBoXrecive.style.display="none"; /* 보낸 메세지함 닫기 */
    messageBoXsend.style.display="flex"; /* 받은 메세지함 열기 */
})
...
messageBoXsendX.addEventListener("click",()=>{ /* 닫기 */
...
gotoMessagerecive.addEventListener("click",()=>{
    messageBoXsend.style.display="none"; /* 받은 메세지함 닫기 */
    messageBoXrecive.style.display="flex"; /* 보낸 메세지함 열기 */
})




// 메세지 클릭 하면 열리고 닫히는 js
// const messagebuttonx = document.querySelector(".recieve-message-x");
// const messageContainer = document.querySelector(".message-container");
// const messageCancleBtn = document.querySelector(".messageCancleBtn");
...
//     messageSendContainer.style.display="flex";
//     if(messageSendContainer.style.display=="flex"){
...
// const recieveMessageEx = document.querySelector(".recieve-message-ex");
// const messageCheck = document.querySelector(".messageCheck");

// recieveMessageEx.addEventListener("click",()=>{
//     messageContainerRe.style.display="flex";
//     if(messageContainerRe.style.display=="flex"){
//         messageCheck.addEventListener("click", () => {
//             messageContainerRe.style.display = 'none';
//         });
//     }
// })
