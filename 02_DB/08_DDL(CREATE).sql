...
CREATE TABLE MEMBER(
	...
	MEMBER_NAME VARCHAR2(15), -- 한글 2글자 ~ 5글자
...
SELECT * FROM MEMBER;
SELECT * FROM USER_TABLES;
			--> 딕셔너리 뷰(데이터 딕셔너리에서 일부만 뽑아 보여주는 가상 테이블)
...
INSERT INTO MEMBER
VALUES('MEM01', '123ABC', '홍길동', '990123-1234567', SYSDATE);
...
-- 가입일 -> SYSDATE를 활용
INSERT INTO MEMBER 
VALUES('MEM02', 'QWE1234', '김영희', '980808-2345678', SYSDATE);

-- 가입일 -> DEFAULT 활용(테이블 생성 시 정의된 값이 반영됨)
INSERT INTO MEMBER 
VALUES('MEM03', '123QWE4', '박철수', '970707-9876543', DEFAULT);
...
VALUES('MEM04', '12341234', '이지연', '010101-4564567');
...
INSERT INTO MEMBER2 VALUES ('김길동', 0001013234567, 01012345678);

SELECT * FROM MEMBER2;
-- 9001011234567  1012345678
-- 1013234567     1012345678

--> NUMBER 타입의 컬럼은 값 제일 앞 0을 유지하지 않는 문제 발생
--> 문제 해결방법 : CHAR, VARCHAR2 타입으로 컬럼 타입을 지정
...
--  USER_ID VARCHAR2(20) UNIQUE, -- 컬럼 레벨 제약조건 설정(이름 미지정) 
...
--  , UNIQUE(USER_ID) -- 제약조건(컬럼명)       (이름 미지정)
    , CONSTRAINT USER_ID_UK UNIQUE(USER_ID) --(이름 O)
);
...
INSERT INTO USER_USED_UK
VALUES(1, 'user01', 'pass01', '홍길동', '남', '010-1234-5678', 'hong123@kh.or.kr');
-- ORA-00001: 무결성 제약 조건(KH_PJK.SYS_C007462)에 위배됩니다 (이름 지정 X)
-- ORA-00001: 무결성 제약 조건(KH_PJK.USER_ID_UK)에 위배됩니다  (이름 지정 O)
--> 같은 아이디인 데이터가 이미 테이블에 있으므로 오류발생
...
CREATE TABLE USER_USED_UK2(
    ...
    -- 테이블 레벨 복합키 지정
    , CONSTRAINT USER_ID_NAME_UK UNIQUE(USER_ID, USER_NAME)
);
...
INSERT INTO USER_USED_UK2
VALUES(1, 'user01', 'pass01', '홍길동', '남', '010-1234-5678', 'hong123@kh.or.kr');
--> ORA-00001: 무결성 제약 조건(KH_PJK.USER_ID_NAME_UK)에 위배됩니다
...
--> 기본키 중복으로 오류
-- ORA-00001: 무결성 제약 조건(KH_PJK.USER_NO_PK)에 위배됩니다

INSERT INTO USER_USED_PK
VALUES(NULL, 'user03', 'pass03', '유관순', '여', '010-9999-3131', 'yoo123@kh.or.kr');
--> 기본키가 NULL 이므로 오류
-- ORA-01400: NULL을 ("KH_PJK"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다
...
-- ORA-00001: 무결성 제약 조건(KH_PJK.PK_USERNO_USERID)에 위배됩니다
...
-- ORA-01400: NULL을 ("KH_PJK"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다
--> 복합키로 PK가 설정되어 있어도 
--  결국은 PK ==> NULL 삽입 불가능
...
-- ORA-02291: 무결성 제약조건(KH_PJK.GRADE_CODE_FK1)이 위배되었습니다- 부모 키가 없습니다

SELECT * FROM USER_USED_FK; -- 자식 테이블
...
WHERE GRADE_CODE = 20;
--> GRADE_CODE = 20번 행은 자식 테이블에서 참조하고 있지 않으므로 
--  삭제가 제한되고 있지 않음!

-- 참조를 하고 있는 GRADE_CODE 10을 삭제
DELETE FROM USER_GRADE 
WHERE GRADE_CODE = 10;
-- ORA-02292: 무결성 제약조건(KH_PJK.GRADE_CODE_FK1)이 위배되었습니다
-- 			  - 자식 레코드가 발견되었습니다
...
-- ORA-02290: 체크 제약조건(KH_PJK.GENDER_CHECK)이 위배되었습니다
...
CREATE TABLE USER_TEST (
	...
	STATUS   CHAR(3) CONSTRAINT NN_STATUS NOT NULL,
...
VALUES (1, 'MEM01', 'PASS01', '001010-3012456', '남', '010-1234-5678', '서울시 종로구', 'Y');
INSERT INTO USER_TEST
VALUES (2, 'MEM02', 'PASS02', '901010-2012456', '여', '010-5555-6666', '서울시 중구', 'N');
INSERT INTO USER_TEST
VALUES (3, 'MEM03', 'PASS03', '000101-4012456', '여', '010-9874-6541', '서울시 성북구', 'Y');
INSERT INTO USER_TEST
VALUES (4, 'MEM04', 'PASS03', '000202-3012456', '남', NULL, '서울시 성북구', 'Y');
INSERT INTO USER_TEST
VALUES (5, 'MEM05', 'PASS03', '801225-1012456', '남', '010-9874-6541', '서울시 종로구', 'Y');
...
-- AS 서브쿼리; -- 서브쿼리의 결과(RESULT SET)의 형태로 테이블 생성
...
-- 3) 테이블의 형태 (컬럼명, 데이터 타입)만 복사 (컬럼 값 X)
...
ALTER TABLE EMPLOYEE ADD CONSTRAINT FK_JOB_CODE
